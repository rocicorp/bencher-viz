                  ...
                  return (
                    <tr key={`${metric.report}-${index}`} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-sm">
                        <a
                          href={`https://github.com/rocicorp/mono/commit/${metric.version.hash}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center hover:underline"
                        >
                          <code className="text-xs bg-gray-100 px-1 py-0.5 rounded hover:bg-gray-200 transition-colors">
